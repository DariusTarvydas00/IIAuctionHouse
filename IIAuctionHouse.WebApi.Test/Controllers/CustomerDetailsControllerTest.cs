...
namespace IIAuctionHouse.WebApi.Test.Controllers
{
    public class CustomerDetailsControllerTest
    {
        ...
        public void AddressController_HasAddressService_IsTypeOfController()
        {
            ...
            var controller = new CustomerDetailsController(service.Object);
        ...
        {
            Assert.Throws<InvalidDataException>(() => new CustomerDetailsController(null));
        }
        ...
        public void AddressController_WithNullAddressService_ThrowsInvalidDataExceptionMessage()
        {
            ...
            var actual = Assert.Throws<InvalidDataException>(() => new CustomerDetailsController(null));
        ...
        {
            var method = typeof(CustomerDetailsController).GetMethods().FirstOrDefault(m => "GetAll".Equals(m.Name));
        ...
        {
            var method = typeof(CustomerDetailsController).GetMethods().FirstOrDefault(m => "GetAll".Equals(m.Name));
            Assert.Equal(typeof(ActionResult<List<CustomerDetails>>).FullName, method.ReturnType.FullName);
        }
        ...
        {
            var mockService = new Mock<ICustomerDetailsService>();
            var controller = new CustomerDetailsController(mockService.Object);
            controller.GetAll();
            mockService.Verify(s=>s.GetAllCustomerDetails(), Times.Once);
        }
        ...
        {
            var methodInfo = typeof(CustomerDetailsController).GetMethods().FirstOrDefault(m => m.Name == "GetAll");
            var attribute =
        ...
        {
            var method = typeof(CustomerDetailsController).GetMethods().FirstOrDefault(m => "GetById".Equals(m.Name));
            Assert.NotNull(method);
        }
        ...
        {
            var method = typeof(CustomerDetailsController).GetMethods().FirstOrDefault(m => "GetById".Equals(m.Name));
            Assert.Equal(typeof(ActionResult<CustomerDetails>).FullName, method.ReturnType.FullName);
        }
        ...
        {
            var methodInfo = typeof(CustomerDetailsController).GetMethods().FirstOrDefault(m => m.Name == "GetById");
            var attribute =
                methodInfo.CustomAttributes.FirstOrDefault(ca => ca.AttributeType.Name == "HttpGetAttribute");
            Assert.NotNull(attribute);
        }
        ...
        {
            var method = typeof(CustomerDetailsController).GetMethods().FirstOrDefault(m => "Post".Equals(m.Name));
            Assert.NotNull(method);
        }
        ...
        {
            var methodInfo = typeof(CustomerDetailsController).GetMethods().FirstOrDefault(m => m.Name == "Post");
            var attribute =
        ...
        {
            var method = typeof(CustomerDetailsController).GetMethods().FirstOrDefault(m => "Delete".Equals(m.Name));
            Assert.NotNull(method);
        }
        ...
        {
            var methodInfo = typeof(CustomerDetailsController).GetMethods().FirstOrDefault(m => m.Name == "Delete");
            var attribute =
